...
object APermission {
  lazy val wildcardToken  = MapperAuth.permissionWilcardToken.vend
  lazy val partDivider    = MapperAuth.permissionPartDivider.vend
  lazy val subpartDivider = MapperAuth.permissionSubpartDivider.vend
